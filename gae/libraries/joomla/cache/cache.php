...
class JCache
{
	...
	public static function getStores()
	{
		...
		$joomlaHandlers = self::getJoomlaStores();

		$gaeHandlers = self::getGaeStores();

		$handlers = array_merge($gaeHandlers, $joomlaHandlers);


		return $handlers;
	}

	public static function getGaeStores()
	{
		$handlers = array();
	...
	public static function getJoomlaStores()
	{
		$handlers = array();

		// Get an iterator and loop trough the driver classes.
		$iterator = new DirectoryIterator(JPATH_LIBRARIES . '/joomla/cache/storage');
