...
abstract class JDatabaseDriver extends JDatabase implements JDatabaseInterface
{
	...
	public static function getConnectors()
	{
		...
		$joomlaConnectors = self::getJConnectors();

		$gaeConnectors = self::getGaeConnectors();

		$connectors = array_merge($gaeConnectors, $joomlaConnectors);

		return $connectors;

	}

	public static function getGaeConnectors()
	{
		$connectors = array();
	...
	public static function getJConnectors()
	{
		$connectors = array();

		// Get an iterator and loop trough the driver classes.
		$iterator = new DirectoryIterator(JPATH_LIBRARIES . '/joomla/database/driver');
